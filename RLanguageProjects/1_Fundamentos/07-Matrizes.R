...
# Número de Linhas 
matrix (c(1,2,3,4,5,6), nr = 2) #number of rows - nr
matrix (c(1,2,3,4,5,6), nr = 3) #com 3 linhas ela faz 2 colunas
matrix (c(1,2,3,4,5,6), nr = 6)


# Número de Colunas
matrix (c( 1,2,3,4,5,6), nc = 2) #number of columns
...
# o padrão é preencher por coluna
meus_dados = c(1:10)
