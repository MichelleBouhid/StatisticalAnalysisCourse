...
# String que o R chama character
...
# Concatenando Strings - funçao CAT
nome = "Nelson"; sobrenome = "Mandela" 
paste(nome, sobrenome)
cat(nome, sobrenome)


# Formatando a saída - PlaceHolder
...
# Usando stringr - Pacote do R que tem que baixar
library(stringr)


# Dividindo uma string em caracteres
# oq antes era uma frase, agora é uma lista de characteres
?strsplit
