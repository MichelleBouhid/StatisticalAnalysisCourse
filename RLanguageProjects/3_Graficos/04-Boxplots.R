...
?boxplot
?sleep #dataset com dados de sono

# Permite utilizar as colunas sem especificar o nome do dataset
attach(sleep)
View(sleep)

# Construção do boxplot - mostrando arelação entre extra e group
sleepboxplot = boxplot(data = sleep, extra ~ group, # ~ relação entre 2 variaveis no R
