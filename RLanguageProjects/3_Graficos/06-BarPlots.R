...
barplot(dados, beside = T) # ao lado = T barras ao lado para cada faixa
barplot(dados) # Stacked Bar Plot - barras empilhadas, se não coloca beside = T

# Construindo o plot - Stacked Bar Plot - barras empilhadas, se não coloca beside = T
