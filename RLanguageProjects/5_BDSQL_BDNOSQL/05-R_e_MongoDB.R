...
# MongoDB - RelationalDataBaseMS equivalências
# MongoDB: Database           => RDBMS: Database
# MongoDB: Collection         => RDBMS: Tabela
# MongoDB: Document           => RDBMS: Linha/Tupla
# MongoDB: Field              => RDBMS: Coluna
# MongoDB: Embedded Documents => RDBMS: Join de Tabelas
# MongoDB: Primary Key => RDBMS: Primary Key
...
coll <- "users.contatos" #nome do bd criado no mongo db
