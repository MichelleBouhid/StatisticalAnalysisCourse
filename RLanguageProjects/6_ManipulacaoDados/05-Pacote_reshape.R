# Remodelando os Dados com Reshape (pertence ao pacote stats que faz parte dos pacotes basicos do R )
...
iris_modif <- reshape(iris, 
                      varying = 1:4, # quais colunas que vai fazer a variação
                      v.names = "Medidas", 
                      timevar = "Dimensoes", 
